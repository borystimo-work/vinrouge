  ...
  if (bodyLockStatus) {
    ...
    setTimeout(() => {
      lockPaddingElements.forEach((el) => {
        if (el.dataset.flsLpType === "right") {
          if (el.dataset.flsLpOriginalRight !== void 0) {
            el.style.right = el.dataset.flsLpOriginalRight + "px";
            delete el.dataset.flsLpOriginalRight;
          }
        } else {
  ...
  if (bodyLockStatus) {
    ...
    lockPaddingElements.forEach((el) => {
      if (el.dataset.flsLpType === "right") {
        ...
        el.dataset.flsLpOriginalRight = currentRight;
        el.style.right = currentRight + lockPaddingValue + "px";
      } else {
